...
Route::post('setPuntaje',[CuestionariosController::class, 'setPuntaje'])->name('cuestionarios.setPuntaje');
...
Route::post('usuarios/imagen',[UsuariosController::class, 'imagen'])->name('usuarios.imagen');
