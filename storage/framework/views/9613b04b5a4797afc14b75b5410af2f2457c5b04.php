        ...
        <div class="flex-container flc" style="width:100%;height:100vh;">
            <div class="body">
                ...
                <div class="row" style="margin-top:35px;">
                    ...
                    <img src="<?php echo e(URL::asset('assets/broken.png')); ?>"/>
                    </div> 
                </div>
            </div>
            <div class="footer">
                <div class="row">
                    ...
                    <div class="col-md-12 d-flex justify-content-center" style="margin-top:20px;">
                        <a href="<?php echo e(route('home.index')); ?>" class="btn btn-primary">Volver</a>
                    </div>
            </div>
        </div>
    </body>
</html>
<?php /**PATH /home1/mynetwp3/public_html/casos/resources/views/errors/minimal.blade.php ENDPATH**/ ?>