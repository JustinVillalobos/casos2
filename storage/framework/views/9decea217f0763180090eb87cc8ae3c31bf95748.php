    ...
    <body class="antialiased">
        <div style="position:absolute;background: white;width:100%;">
            <header >
                <div class="row">
                    <div class="col-sm-4">
                    <img src="<?php echo e(URL::asset('assets/LOGO NET.jpeg')); ?>" style="width:220px;"/>
                    </div>
            ...
            <nav class="d-flex align-items-center" style="padding: 0px 0px 0px 10px;    margin-top: 35px;opacity:0.9;">
                <div class="row " style="width: 99%;">
                    <div class="col-sm-2 d-flex align-items-center justify-content-center text-center border-right">
                        <a href="<?php echo e(route('cuestionarios.index')); ?>" class="text-white font-weight-bold"><i class="fa fa-cog" aria-hidden="true"></i> Cuestionarios</a>
                    </div>
                    <?php $case=8;?>
                    <?php if(!empty($_SESSION['id'])): ?>
                        <?php if($_SESSION['id']==1): ?>
                            <?php $case=6;?>
                            <div class="col-sm-2 d-flex align-items-center justify-content-center text-center border-right">
                                <a href="<?php echo e(route('usuarios.index')); ?>" class="text-white font-weight-bold"><i class="fa fa-cog" aria-hidden="true"></i> Usuarios</a>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
                    <div class="col-sm-2 d-flex align-items-center justify-content-center text-center border-right">
                        <a href="<?php echo e(route('usuarios.perfil')); ?>" class="text-white font-weight-bold"><i class="i i-cogs" aria-hidden="true"></i> Perfil</a>
                    </div>
                    <div class="col-sm-<?php echo e($case); ?> d-flex align-items-center justify-content-end text-center ">
                        <a href="<?php echo e(route('login.logout')); ?>" class="text-white font-weight-bold"><i class="fa fa-sign-out" aria-hidden="true"></i> </a>
                    </div>
                </div>
            </nav>
...
</html><?php /**PATH /home1/mynetwp3/public_html/cuestionarios/resources/views///layouts/admin.blade.php ENDPATH**/ ?>