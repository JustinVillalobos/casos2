    ...
    <div class="col-sm-12">
        <div class="" style="padding-left:5px;">
            ...
            <li class="breadcrumb-item"><a href='<?php echo e(route("cuestionarios.index")); ?>' class="text-info"> <h5><i class="fa fa-book" aria-hidden="true"></i>Casos De Estudio</h5></a></li>
                <li class="breadcrumb-item active" aria-current="page">Sala <?php echo e($cuestionario->titulo); ?></li>
...
<div class="row" style="margin-top:15px;padding-left:5px;">
    ...
    <form action='<?php echo e(route("cuestionarios.busquedaSala")); ?>' method="GET" class="d-flex"  style="margin: 0px;">
            ...
            <input type="hidden"  id="idSala" value="<?php echo e($idSala); ?>" name="idSala" />
            <button type="submit" class="btn btn-success" style="margin-left:5px">
                <i class="fa fa-search"></i>
            </button>
                                        
        </form>
        <a href='<?php echo e(route("cuestionarios.index")); ?>/<?php echo e($cuestionario->idCuestionario); ?>' class="btn btn-primary" style="margin-left:5px">
            <i class="fa fa-refresh"></i>
        </a>
        <button id="button" class="btn btn-info text-white" style="margin-left:5px">
            <i class="fa fa-play" aria-hidden="true"></i>
        </button>
        <a href='<?php echo e(route("cuestionarios.graficos", [$cuestionario])); ?>' class="btn btn-warning text-white" style="margin-left:5px">
...
<div class="row" style="margin-top:15px;padding-left:5px;padding-bottom:15px;">
   ...
   <div class="row" id="data_table">
        <?php echo $__env->make('../cuestionarios/table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   </div>
</div>
</div>
<?php $route2 = route("cuestionarios.index");?>
<input type="hidden" value="<?php echo e($route2); ?>" id="route" />
<script src="<?php echo e(URL::asset('js/cuestionarios/sala.js')); ?>"></script>        
<?php $__env->stopSection(); ?>
 
<?php echo $__env->make('./layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mynetwp3/public_html/casos/resources/views/cuestionarios/sala.blade.php ENDPATH**/ ?>