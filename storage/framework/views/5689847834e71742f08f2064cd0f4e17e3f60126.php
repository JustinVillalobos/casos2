                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-center align-items-center">
                            <?php $img=strlen($nivel->imagen);?>
                                    <?php if($img < 3): ?>
                                        <img src="<?php echo e(URL::asset('assets/avatars/avatar'.$nivel->imagen.'.png')); ?>" style="width:55px;height:55px;"/>
                                    <?php endif; ?>
                                    <?php if($img >= 3): ?>
                                        <img src="<?php echo e(URL::asset($nivel->imagen)); ?>" style="width:55px;height:55px;"/>
                                    <?php endif; ?>
                        </td>
                        ...
                        <td style="width:125px;" >
                            <div class="d-flex justify-content-center align-items-center" style="height: 55px">
                                ...
                                <form action='<?php echo e(route("cuestionarios.edit", [$nivel])); ?>' method="post" >
                                    <?php echo method_field("get"); ?>
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <button type="submit" class="btn btn-primary text-white" style="margin-left:5px;width:25px;height:29px;" data-toggle="modal" data-target="#myModal" onclick="changeStatus('<?php echo e($nivel->codigo); ?>','<?php echo e($nivel->disponible); ?>','<?php echo e($nivel->titulo); ?>')">
...
<?php echo $__env->make('./layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mynetwp3/public_html/casos/resources/views/cuestionarios/index.blade.php ENDPATH**/ ?>