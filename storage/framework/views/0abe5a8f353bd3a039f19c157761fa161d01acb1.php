...
<div class="row" style="margin-top:15px;padding-left:5px;">
    <div class="col-sm-6" style="padding:10px 20px 0px 20px;">
        ...
        <div class="row" style="margin-top:5px;">
         ...
         <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class="text-danger font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">Tipo De Usuario:</label>
                 <select class="form-control form-select" style="width:67%;" id="typeuser">
                    <option value="0">Colaborador de la empresa</option>
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class=" font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">Logo:</label>
                <input type="file" class="form-control" style="width:67%;" id="logo"/>
                 <span class="text-danger" style="width:100%;margin-right:25%;font-size:11px;"></span>
             </div>
        </div>
    </div>
...
<script src="<?php echo e(URL::asset('js/usuarios/add.js')); ?>"></script>        
<?php $__env->stopSection(); ?>
 
<?php echo $__env->make('./layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mynetwp3/public_html/casos/resources/views/usuarios/add.blade.php ENDPATH**/ ?>