...
<div class="row" style="margin-top:15px;padding-left:5px;">
    ...
    <div class="col-sm-6 d-flex justify-content-center align-items-center">
        <div class="col-sm-12 d-flex justify-content-center align-items-center">
                        <img src="<?php echo e(URL::asset('assets/avatars/avatar1.png')); ?>" id='profile' style="width:255px;"/>
        </div>
    </div>
    <div class="col-sm-12" style="padding:10px 20px 0px 20px;">
...
<?php echo $__env->make('./layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cuestionarios\resources\views/cuestionarios/add.blade.php ENDPATH**/ ?>